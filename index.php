...
if ($_POST) {
    ...
    if (empty($errors)) {
        ...
        // Configuration 1: Try hosting server (for live server)
        $hostingConfig = [
            'host' => 'localhost',
            'username' => '',
            'password' => '',
            'port' => 25,
            'encryption' => '',
            'from_email' => 'noreply@scentview.pk'
        ];
        
        // Configuration 2: Try Gmail (for localhost/fallback)
        $gmailConfig = [
            'host' => $env['SMTP_HOST'],
        ...
        $configs = [$hostingConfig, $gmailConfig];
        ...
        foreach ($configs as $index => $config) {
            ...
            try {
                ...
                // Recipients
                $mail->setFrom($config['from_email'], 'Perfume Store Order');
            ...
            $emailBody .= "
                ...
                // Log error and try next configuration
